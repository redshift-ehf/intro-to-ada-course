...
with Ada.Assertions;
with Ada_Check;
with Pythagoras_Predicate;

procedure Test_Pythagoras_Predicate is
   use Pythagoras_Predicate;
...
begin
   Ada_Check.Suite ("Pythagorean Theorem: Predicate");
