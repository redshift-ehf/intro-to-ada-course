...
with Ada.Assertions;
with Ada_Check;
with Pythagoras_Precondition;

procedure Test_Pythagoras_Precondition is
   use Pythagoras_Precondition;
...
begin
   Ada_Check.Suite ("Pythagorean Theorem: Precondition");
...
end Test_Pythagoras_Precondition;
