...
begin
   ...
   Ada_Check.Equal
     (Name     => "counts up from 1 to 5",
      Actual   => Ada_Check.Output_Of (Numbers'Access, 1, 5),
   ...
   Ada_Check.Equal
     (Name     => "counts up even when given 5 and 1",
      Actual   => Ada_Check.Output_Of (Numbers'Access, 5, 1),
      Expected => " 1" & LF & " 2" & LF & " 3" & LF & " 4" & LF & " 5");

   Ada_Check.Equal
     (Name     => "a range of one number",
      Actual   => Ada_Check.Output_Of (Numbers'Access, 3, 3),
      Expected => " 3");

   Ada_Check.Equal
     (Name     => "a range crossing zero",
      Actual   => Ada_Check.Output_Of (Numbers'Access, -2, 1),
