...
with Ada_Check;
with Imp_Ifelse_Classify;

procedure Test_Imp_Ifelse_Classify is
begin
   Ada_Check.Suite ("Positive Or Negative");

   Ada_Check.Equal
     (Name     => "a positive number",
      Actual   => Ada_Check.Output_Of (Imp_Ifelse_Classify'Access, 42),
      Expected => "Positive");
   ...
   Ada_Check.Equal
     (Name     => "zero",
      Actual   => Ada_Check.Output_Of (Imp_Ifelse_Classify'Access, 0),
      Expected => "Zero");

   Ada_Check.Equal
     (Name     => "one, just above zero",
      Actual   => Ada_Check.Output_Of (Imp_Ifelse_Classify'Access, 1),
      Expected => "Positive");
