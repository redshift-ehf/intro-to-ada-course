...
In terms of modern languages, the closest in terms of targets and level of abstraction are probably [C++](https://en.wikipedia.org/wiki/C%2B%2B) and [Rust](https://www.rust-lang.org/).
...
* Explicit is better than implicit. Although this is a [Python](https://www.python.org/) commandment, Ada takes it way further than any language we know of:
